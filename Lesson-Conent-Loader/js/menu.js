...
function animateScroll(container, scrollType) {
	if (scrollKTHVisible == false)
		setTimeout(animateScroll2(container, 1, scrollKTHVisible, scrollType), 20 );
	else 
		setTimeout(animateScroll2(container, 58, scrollKTHVisible, scrollType), 20 );
}
function animateScroll2(container, index, visible, scrollType) {
	...
	if(index < 1 || index > 58) {
		...
		setTimeout(animateScroll2, 20, container, index, visible, scrollType);
	}
}
