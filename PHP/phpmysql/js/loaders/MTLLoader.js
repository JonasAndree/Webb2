...
THREE.MTLLoader.prototype = {
	 ...
	 *       must call setPath and/or setTexturePath explicitly prior to load.
	 */
	...
	/**
	 * Set base path for resolving references. If set this path will be
	 * prepended to each loaded and found reference.
	 * 
	 * @see setTexturePath
	 * @param {String}
	 *            path
	 ...
	 * 
	 * @example mtlLoader.setPath( 'assets/obj/' ); mtlLoader.load( 'my.mtl',
	 *          ... );
	 */
	...
	/**
	 * Set base path for resolving texture references. If set this path will be
	 * prepended found texture reference. If not set and setPath is, it will be
	 * used as texture base path.
	 * 
	 * @see setPath
	 * @param {String}
	 *            path
	 * @return {THREE.MTLLoader}
	 * 
	 * @example mtlLoader.setPath( 'assets/obj/' ); mtlLoader.setTexturePath(
	 *          'assets/textures/' ); mtlLoader.load( 'my.mtl', ... );
	 */
	 ...
	 * 
	 * @note In order for relative texture references to resolve correctly you
	 *       must call setPath and/or setTexturePath explicitly prior to parse.
	 */
	parse: function ( text ) {
